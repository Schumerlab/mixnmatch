...
# usage
# perl parsetsv_to_genotypes_v2.pl par1.tsv par2.tsv posterior_threshold outname

if (@ARGV<4){
	print "\nusage: perl  parsetsv_to_genotypes_v2.pl par1.tsv par2.tsv posterior_threshold outfile_name\n\n"; }
