...
if(@ARGV<4){
    print "perl post_hmm_accuracy_shell.pl ancestry-par1.tsv ancestry-par2.tsv simulation_folder path_to_Simulator_install\n"; exit;
}
...
system("perl $path/parsetsv_to_genotypes_v2.pl $file1 $file2 $genos");
